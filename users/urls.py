...
from .views import  RegisterView, LoginView, LogoutView, OTPVerify, UserDetail, UserCriteria, UserRequestView, UserUpdate, UserCheckout , MakeUsersView, UserExistsView, UserCartUpdate, UserAvatarUpdate, UserRequest,ParticipationStatusView,CriteriaView #, TeamList
...
urlpatterns = [
    ...
    path('criteriacheck/', CriteriaView.as_view())
